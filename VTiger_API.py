...
#Returns a count of the items that match the query. In this case, returns the amount of open cases.
#>>> r_text
#{'success': True, 'result': [{'count': '229'}]}
#url = f"{host}/query?query=SELECT COUNT(*) FROM Cases WHERE casestatus != 'closed' AND casestatus != 'resolved';"
